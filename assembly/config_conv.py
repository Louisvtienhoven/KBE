...
class WingMounted(GeomBase):
    ...
    @Part
    def pylon(self):
        return Pylon(position=translate(self.position.rotate90('y','z'),
    ...
    def channel_htail2(self):
        return MirroredShape(shape_in=self.channel_htail1,
                             reference_point=self.position,
                             # Two vectors to define the mirror plane
                             vector1=self.position.Vz,
                             vector2=self.position.Vx,
    ...
    def channel_htail4(self):
        return MirroredShape(shape_in=self.channel_htail3,
                             reference_point=self.position,
                             # Two vectors to define the mirror plane
                             vector1=self.position.Vz,
                             vector2=self.position.Vx,
    ...
    def channel_htail8(self):
        return MirroredShape(shape_in=self.channel_htail7,
                             reference_point=self.position,
                             # Two vectors to define the mirror plane
                             vector1=self.position.Vz,
                             vector2=self.position.Vx,
